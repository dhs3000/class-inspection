 ...
 * @param <T>
 */
public class ClassEnumerator<T> {
    static final Logger logger = Logger.getLogger(ClassEnumerator.class);

    private ClassLoader _classloader = Thread.currentThread().getContextClassLoader();

    private final ClassInspector<T> _inspector;
     ...
     */
    public ClassEnumerator(ClassInspector<T> inspector, String packageName) {
     ...
     */
    public ClassInspector<T> findAndLetInspect() {
    ...
    static final class InspectionHelperImpl implements InspectionHelper {
        ...
        private class NativeClassInfo implements ClassInfo {
        ...
        private class ClassFileClassInfo implements ClassInfo {
